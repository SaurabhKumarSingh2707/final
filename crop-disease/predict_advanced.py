    ...
    def load_model(self):
        ...
        try:
            if os.path.exists(self.model_path):
                ...
                self.IMG_HEIGHT = 300
                self.IMG_WIDTH = 300
                print(f"✅ Advanced model loaded from {self.model_path}")
    ...
    def load_class_names(self):
        ...
        try:
            ...
            if os.path.exists(self.class_names_path):
                ...
                # Fallback to basic class names - use absolute path
                script_dir = os.path.dirname(os.path.abspath(__file__))
                fallback_path = os.path.join(script_dir, 'class_names.txt')
